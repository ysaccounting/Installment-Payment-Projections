...
st.markdown("""
<div class="hero">
    <h1>Installment<br><em>Projections</em></h1>
    <p>Upload the QBO ticket credit general ledger (one company or consolidated) for any time period in the prior month to project the same period in the coming month.</p>
</div>
""", unsafe_allow_html=True)
